...
Poiesis is a **Claude Code plugin** that automates the entire journey from a raw product idea to a client-ready commercial proposal. It orchestrates specialized AI agents across five phases — research, strategy, technical feasibility, GTM execution, and pre-sales — producing real, usable artifacts at every step.
...
- A **technical feasibility assessment** with architecture options, effort estimation, dependency analysis, and a FEASIBLE/NOT-FEASIBLE verdict
- A **GTM kit** including a working HTML prototype, a Remotion promo video, and a full marketing asset suite (copy, social content, launch plan, sales materials, cold outreach)
- A **pre-sales package** with commercial proposal, pricing model, technical summary, risk mitigation plan, and case for action

Everything is generated by specialized agents running in parallel, with quality gates between each phase. If the idea isn't viable (business or technical), the pipeline stops early and tells you why.
...
| **Technical assessment** | Engineering team spends days scoping | Architecture options, effort estimates, dependency audit, FEASIBLE/NOT-FEASIBLE verdict |
...
| **Commercial proposal** | Account manager + pre-sales engineer | Pricing model, technical summary, risk plan, case for action |
...
### Phase 3 — Technical Feasibility (5 artifacts)

| File | What it contains |
|---|---|
| `01-architecture-assessment.md` | 2-3 architecture options with trade-offs, recommended MVP stack |
| `02-effort-estimation.md` | MVP epics with person-week estimates, team composition, timeline |
| `03-third-party-dependencies.md` | External services/APIs with pricing, lock-in risk, alternatives |
| `04-technical-risks.md` | 5+ risks ranked by severity with mitigations |
| `feasibility-report.md` | **VERDICT: FEASIBLE/NOT-FEASIBLE** + cost estimates + top risks |

### Phase 4 — GTM (12+ artifacts)
...
### Phase 5 — Pre-sales (6 artifacts)

| File | What it contains |
|---|---|
| `01-commercial-proposal.md` | Full commercial proposal: scope, deliverables, timeline, investment |
| `02-pricing-model.md` | Cost breakdown by epic, 2-3 pricing options, payment milestones |
| `03-technical-summary.md` | Client-facing tech overview with architecture diagram |
| `04-risk-mitigation-plan.md` | Risk matrix with mitigations and contingency plans |
| `05-case-for-action.md` | Market window, ROI timeline, cost of inaction, quick wins |
| `proposal-package.md` | Complete package: executive brief + recommended option + next steps |
...
poiesis/
  ...
  agents/
    ...
    technical-feasibility-director.md  # Phase 3: spawns 4 tech specialists
    gtm-director.md                # Phase 4: design → video || marketing
    presales-director.md           # Phase 5: spawns 5 pre-sales specialists
    references/
