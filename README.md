...
| **Technical assessment** | Engineering team spends days scoping | High-level feasibility check: effort, risks, dealbreakers |
...
<p align="center">
  <img src="assets/pipeline.png" alt="Poiesis Pipeline — 5 phases from idea to proposal" width="100%" />
</p>
...
### Phase 3 — Technical Feasibility (3 artifacts)

High-level sanity check, not a detailed spec. Catches impractical ideas before GTM investment.

| File | What it contains |
|---|---|
| `01-build-assessment.md` | Architecture approach, MVP epics (T-shirt sized), team, dependencies, timeline |
| `02-risk-scan.md` | Top 5 technical dealbreaker risks with severity and mitigations |
| `feasibility-report.md` | **VERDICT: FEASIBLE/NOT-FEASIBLE** + effort estimate + ballpark cost |
